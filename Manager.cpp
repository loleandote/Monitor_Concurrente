...
int main (int argc, char *argv[]){
    ...
    pthread_attr_t attr;
    /**** POR HACER ****/
     Puente *puente = new Puente(N_S);/* Monitor que controla el puente, recibe la cadena de 						caracteres "N->S" o bien "S->N" como sentido del "turno 					inicial" que empezará atravesando el puente */
    ...
    for (i=0; i<NUM_COCHES; i++){   
        ...
        /**** POR HACER ****/
         pthread_create(&hilosCoches[i], &attr,coche_func,argv[1]); /* Crear hilo que ejecute concurrentemente la función coche_func()*/
